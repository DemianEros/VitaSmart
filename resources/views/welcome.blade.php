...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!-- Background Video-->
        <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="EstilosWelcome/mp4/bg5.mp4" type="video/mp4" /></video>
        <!-- Masthead-->
        <div class="masthead">
        ...
        <div class="social-icons">
            <div class="d-flex flex-row flex-lg-column justify-content-center align-items-center h-100 mt-3 mt-lg-0">
                ...
                <a href="#" class="btn btn-dark m-3 icon-link"><img src="IconoIDY.ico" alt="Ícono Personalizado"><span class="link-text">Conocenos</span></a>
