...
<body>
    <div id="app">
        <nav style="background-color: #001D40;" class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                <a href="{{ route('login') }}" style="background-color: #052b58ee" class="btn btn-primary font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Inicia Sesion</a>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                <a href="{{ route('register') }}" style="background-color :#052b58ee" class="btn btn-primary ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrate</a>
                                </li>
                            @endif
                        @else
    ...
    <footer style="position: absolute; bottom: 0; width: 100%; height: 100px; background-color: #001D40; color: #fff; padding: 20px; display: flex; justify-content: space-between; align-items: center;">
